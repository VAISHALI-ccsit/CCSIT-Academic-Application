...
public class Register_Principal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // phone_no = findViewById(R.id.Reg_Phone);
                            ...
                            addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if(task.isSuccessful()){
                                        ...
                                        Toast.makeText(Register_Principal.this, "Registration Successful", Toast.LENGTH_SHORT).show();
                                    }else{
                                        progressDialog.dismiss();
                                        Toast.makeText(Register_Principal.this, ""+task.getException(), Toast.LENGTH_SHORT).show();
    ...
    private void sendUserToNextActivity() {
        Intent intent = new Intent(Register_Principal.this, Login_Activity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);

    }

    public void Login_principal(View view) {
        Intent intent = new Intent(Register_Principal.this, Login_Activity.class);
        startActivity(intent);
    }
    @Override
