...
public class MTech_Registration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mtech_registration);
        ...
        reg.setOnClickListener(new View.OnClickListener() {
                            ...
                            addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if(task.isSuccessful()){
                                        ...
                                        Toast.makeText(MTech_Registration.this, "Registration Successful", Toast.LENGTH_SHORT).show();
                                    }else{
                                        progressDialog.dismiss();
                                        Toast.makeText(MTech_Registration.this, ""+task.getException(), Toast.LENGTH_SHORT).show();
            ...
            private void sendUserToNextActivity() {
                Intent intent = new Intent(MTech_Registration.this, BCA_Login.class);
    ...
    public void Login_MTech(View view) {
