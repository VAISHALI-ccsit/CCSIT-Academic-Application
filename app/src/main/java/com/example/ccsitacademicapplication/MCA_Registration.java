...
public class MCA_Registration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mca_registration);
        ...
        reg.setOnClickListener(new View.OnClickListener() {
                            ...
                            addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if(task.isSuccessful()){
                                        ...
                                        Toast.makeText(MCA_Registration.this, "Registration Successful", Toast.LENGTH_SHORT).show();
                                    }else{
                                        progressDialog.dismiss();
                                        Toast.makeText(MCA_Registration.this, ""+task.getException(), Toast.LENGTH_SHORT).show();
            ...
            private void sendUserToNextActivity() {
                Intent intent = new Intent(MCA_Registration.this, MCA_Login.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
            }
        });
    }
    public void Login_MCA(View view) {
