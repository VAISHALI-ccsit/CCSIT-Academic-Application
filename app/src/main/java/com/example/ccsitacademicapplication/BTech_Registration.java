...
public class BTech_Registration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reg.setOnClickListener(new View.OnClickListener() {
                            ...
                            addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if(task.isSuccessful()){
                                        ...
                                        Toast.makeText(BTech_Registration.this, "Registration Successful", Toast.LENGTH_SHORT).show();
                                    }else{
                                        progressDialog.dismiss();
                                        Toast.makeText(BTech_Registration.this, ""+task.getException(), Toast.LENGTH_SHORT).show();
            ...
            private void sendUserToNextActivity() {
                Intent intent = new Intent(BTech_Registration.this, BCA_Login.class);
    ...
    public void Login_BTech(View view) {
