...
public class BSc_Registration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bsc_registration);

        inputEmail = findViewById(R.id.Reg_email_bsc);
        ...
        reg.setOnClickListener(new View.OnClickListener() {
                            ...
                            addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if(task.isSuccessful()){
                                        ...
                                        Toast.makeText(BSc_Registration.this, "Registration Successful", Toast.LENGTH_SHORT).show();
                                    }else{
                                        progressDialog.dismiss();
                                        Toast.makeText(BSc_Registration.this, ""+task.getException(), Toast.LENGTH_SHORT).show();
            ...
            private void sendUserToNextActivity() {
                Intent intent = new Intent(BSc_Registration.this, BCA_Login.class);
    ...
    public void Login_BSc(View view) {
