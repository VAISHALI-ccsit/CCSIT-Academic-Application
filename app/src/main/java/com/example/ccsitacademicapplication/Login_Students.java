...
public class Login_Students extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputEmail=findViewById(R.id.login_username_stu);
        inputPassword=findViewById(R.id.login_password_stu);

        btnLogin = findViewById(R.id.login_button_stu);
            ...
            mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful()){
                        ...
                        sendUserToActivity();
                        Toast.makeText(Login_Students.this, "Login Successful", Toast.LENGTH_SHORT).show();
                    }else{
                        progressDialog.dismiss();
                        Toast.makeText(Login_Students.this, " "+task.getException(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    private void sendUserToActivity() {
        Intent intent = new Intent(Login_Students.this, Students_Dashboard.class);
    ...
    public void Register(View view) {
        Intent intent = new Intent(this, Registration_Students.class);
        startActivity(intent);
    }
    @Override
